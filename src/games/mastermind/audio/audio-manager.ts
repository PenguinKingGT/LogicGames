import { SOUND_STEPS, type SoundCue } from "@/games/mastermind/audio/sounds"
  ...
  async play(cue: SoundCue): Promise<void> {
    ...
    try {
      ...
      for (const step of SOUND_STEPS[cue]) {
        ...
        gain.gain.exponentialRampToValueAtTime(step.gain, toneStart + 0.015)
      ...
      // Audio is optional and must never interrupt a game action.
    }
  }
